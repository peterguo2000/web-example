...
import com.dbwatcher.dbwatcherapi.controller.DBWatcherAPIController;
...
public class DBWatcherAPIControllerTest {

    @Autowired
    private MockMvc mockMvc;

//    @Autowired
 //   private DBWatcherController dbWatcherController;
...
/*
    ...
    public void shouldFindAllTodos() throws Exception {
        ...
        given(dbWatcherController.getAllTodos()).willReturn(ResponseEntity.ok(allTodos));
